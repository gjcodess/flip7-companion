-- A player must have at least two cards before staying or banking.
...
begin
  ...
  if v_card_count < 2 then raise exception 'You need at least 2 cards before you can stay'; end if;
